...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cases.site'
        db.add_column('hid_cases', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hid.Site'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'hid.cases': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hid.Site']", 'null': 'True', 'blank': 'True'}),
