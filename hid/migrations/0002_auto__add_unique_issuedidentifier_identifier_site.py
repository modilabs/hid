...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'IssuedIdentifier', fields ['identifier', 'site']
        db.create_unique('hid_issuedidentifier', ['identifier_id', 'site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'IssuedIdentifier', fields ['identifier', 'site']
        db.delete_unique('hid_issuedidentifier', ['identifier_id', 'site_id'])
