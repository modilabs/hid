...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IdentifierRequest.task_progress'
        db.add_column('hid_identifierrequest', 'task_progress',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IdentifierRequest.task_progress'
        db.delete_column('hid_identifierrequest', 'task_progress')
