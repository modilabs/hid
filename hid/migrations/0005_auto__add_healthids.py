...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HealthIDs'
        db.create_table('hid_healthids', (
        ...
        db.send_create_signal('hid', ['HealthIDs'])

        # Adding M2M table for field site on 'HealthIDs'
        db.create_table('hid_healthids_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('healthids', models.ForeignKey(orm['hid.healthids'], null=False)),
            ('site', models.ForeignKey(orm['hid.site'], null=False))
        ))
        db.create_unique('hid_healthids_site', ['healthids_id', 'site_id'])


    def backwards(self, orm):
        # Deleting model 'HealthIDs'
        db.delete_table('hid_healthids')

        # Removing M2M table for field site on 'HealthIDs'
        db.delete_table('hid_healthids_site')
    ...
    models = {
        ...
        'hid.healthids': {
            'Meta': {'object_name': 'HealthIDs'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'site': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['hid.Site']", 'symmetrical': 'False'}),
