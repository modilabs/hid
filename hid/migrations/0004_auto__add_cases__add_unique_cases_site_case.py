...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cases'
        db.create_table('hid_cases', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hid.Site'])),
            ('case', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('identifier', self.gf('django.db.models.fields.related.ForeignKey')(max_length=10, to=orm['hid.Identifier'], null=True, blank=True)),
        ))
        db.send_create_signal('hid', ['Cases'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Cases'
        db.delete_table('hid_cases')
